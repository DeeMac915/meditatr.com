                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div className="prose max-w-none">
                        ...
                        <p className="text-gray-700 mb-6">
                            By accessing and using the Meditation MVP platform,
                        ...
                        <p className="text-gray-700 mb-6">
                            ...
                            copy of the materials on Meditation MVP for
                        ...
                        <p className="text-gray-700 mb-6">
                            The materials on Meditation MVP are provided on an
                            'as is' basis. Meditation MVP makes no warranties,
                        ...
                        <p className="text-gray-700 mb-6">
                            In no event shall Meditation MVP or its suppliers be
                            liable for any damages arising out of the use or
                            inability to use the materials on Meditation MVP.
                        </p>
